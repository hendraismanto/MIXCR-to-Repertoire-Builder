...
def main():
    ...
    if args['species'] == 'mouse':
        preprocess(reader, nonfunc_ig_mouse).to_csv(filename_only + '_filtered.txt', sep = '\t', index = False)

    else:
        preprocess(reader, nonfunc_ig_human).to_csv(filename_only + '_filtered.txt', sep = '\t', index = False)
